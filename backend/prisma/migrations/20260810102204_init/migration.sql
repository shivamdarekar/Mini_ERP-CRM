...
-- CreateIndex
CREATE INDEX "FollowUpNote_createdBy_idx" ON "FollowUpNote"("createdBy");
...
-- AddForeignKey
ALTER TABLE "FollowUpNote" ADD CONSTRAINT "FollowUpNote_createdBy_fkey" FOREIGN KEY ("createdBy") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
